...
public class FinanceiroController implements Initializable {
    ...
    @FXML private TableColumn<TransacaoFinanceira, Void> colAcoes;  // ✅ AGORA TEM!
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        dataInicioPicker.valueProperty().addListener((obs, oldVal, newVal) -> carregarDados());
        dataFimPicker.valueProperty().addListener((obs, oldVal, newVal) -> carregarDados());
    }
    ...
    @FXML
    private void onSair() {  // ✅ SEM ActionEvent!
